...
class YashLogin extends Template implements ActionListener, Runnable
{
	JButton SUBMIT;
	...
	YashLogin()
	{
		...
		TopLable.setText("Yash Packer Unpacker : Login");
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if( ae.getSource() == SUBMIT)
		{
			if(Validate(value1,value2)== false)
			{
				text1.setText("");
				text2.setText("");
				JOptionPane.showMessageDialog(this, "Short username","Yash Packer Unpacker",JOptionPane.ERROR_MESSAGE);
			}
			if(value1.equals("YASH")&&value2.equals("YASH@123"))
			{
			...
			else
			{
				...
				if(attemp == 0)
				{
					JOptionPane.showMessageDialog(this,"Number of attempts finished","Yash Packer Unpacker",JOptionPane.ERROR_MESSAGE);
					this.dispose();
					System.exit(0);
				}
